            ...
            <form action="{{ route('dashboard') }}" method="GET" class="glass-panel w-full max-w-4xl rounded-2xl p-4 md:p-5 shadow-lg border border-outline-variant/30 flex flex-col md:flex-row gap-3 items-end text-left">
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        ...
                        <select name="zone_id" required class="w-full bg-none bg-surface border border-outline-variant/50 rounded-xl py-2.5 pl-10 pr-8 text-[14px] text-on-surface focus:border-primary focus:ring-0 outline-none transition-all appearance-none cursor-pointer relative z-20" style="background-image: none !important;">
                        ...
                        <span class="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-on-surface-variant/50 text-[20px] pointer-events-none z-30">expand_more</span>
                    </div>
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="relative">
                        <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-primary text-[20px] z-10">directions_car</span>
                        <select name="type" class="w-full bg-surface bg-none border border-outline-variant/50 rounded-xl py-2.5 pl-10 pr-8 text-[14px] text-on-surface focus:border-primary focus:ring-0 outline-none transition-all appearance-none cursor-pointer relative z-20" style="background-image: none !important;">
    ...
    <section class="py-10 bg-background" id="armada">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                ...
                <!-- UBAH DIV MENJADI TAG A AGAR BISA DIKLIK SEMUA -->
                <a href="{{ route('vehicle.show', $car->id) }}" class="vehicle-card block bg-surface border border-outline-variant/60 rounded-xl overflow-hidden transition-all duration-300 premium-shadow group relative flex flex-col hover:border-primary/50 hover:shadow-lg cursor-pointer">
                    ...
                    <div class="h-44 overflow-hidden bg-surface-container flex items-center justify-center p-4 relative">
                       <img src="{{ $car->primaryImage ? Storage::url($car->primaryImage->image_url) : 'https://placehold.co/400x250?text=Mobil' }}"
                            alt="{{ $car->name }}"
                    ...
                    <div class="p-4 flex-grow flex flex-col">
                        ...
                        <!-- Ganti Teks Tombol jadi Lihat Detail -->
