        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center mt-6">
          ...
          <!-- Cari baris h1 Selamat Datang -->
            ...
            <form action="{{ route('dashboard') }}" method="GET" class="glass-panel w-full max-w-4xl rounded-2xl p-4 md:p-5 shadow-lg border border-outline-variant/30 flex flex-col md:flex-row gap-3 items-end text-left">
                ...
                <!-- 1. Input Lokasi -->
                <div class="w-full">
                    <label for="zone_id" class="font-inter font-semibold text-[13px] text-on-surface-variant mb-1.5 block">Lokasi Penjemputan</label>
                    <div class="relative">
                ...
                <div class="w-full">
                    <label for="start_date" class="font-inter font-semibold text-[13px] text-on-surface-variant mb-1.5 block">Tgl Ambil</label>
                    <div class="relative">
                ...
                <div class="w-full">
                    <label for="end_date" class="font-inter font-semibold text-[13px] text-on-surface-variant mb-1.5 block">Tgl Kembali</label>
                    <div class="relative">
                ...
                <!-- 4. Input Kategori -->
                <div class="w-full">
                    <label for="type" class="font-inter font-semibold text-[13px] text-on-surface-variant mb-1.5 block">Kategori</label>
                    <div class="relative">
